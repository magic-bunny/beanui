...
//    是否显示 x 轴。
    ...
    String gridIndex() default "";// number
//[ default: 0 ]
//    x 轴所在的 grid 的索引，默认位于第一个 grid。
//
//    String position() default "";// string
//    x 轴的位置。
//
//    可选：
//
...
//    坐标轴名称。
    ...
    String nameLocation() default "";// string
//[ default: 'end' ]
//    坐标轴名称显示位置。
//
//    可选：
...
//            'middle' 或者 'center'
//            'end'
//    String nameTextStyle() default "";// Object
//    坐标轴名称的文字样式。

    String nameGap() default "";// number
//[ default: 15 ]
//    坐标轴名称与轴线之间的距离。

    String nameRotate() default "";// number
//[ default: null ]
//    坐标轴名字旋转，角度值。

    String inverse() default "";// boolean
//[ default: false ]
//    是否是反向坐标轴。ECharts 3 中新加。

    String boundaryGap() default "";// boolean, Array
...
//    boundaryGap: ['20%', '20%']
    String min() default "";// number,() default "";// string, function
//[ default: null ]
//    坐标轴刻度最小值。
//
...
//    其中 value 是一个包含 min 和 max 的对象，分别表示数据的最大最小值，这个函数应该返回坐标轴的最小值。
    ...
    String max() default "";// number,() default "";// string
//[ default: null ]
//    坐标轴刻度最大值。
//
...
//    在设置 min 和 max 之后该配置项无效。
    ...
    String splitNumber() default "";// number
//[ default: 5 ]
//    坐标轴的分割段数，需要注意的是这个分割段数只是个预估值，最后实际显示的段数会在这个基础上根据分割后坐标轴刻度显示的易读程度作调整。
//
//    在类目轴中无效。

    String minInterval() default "";// number
//[ default: 0 ]
//    自动计算的坐标轴最小间隔大小。
//
...
//    只在数值轴或时间轴中（type: 'value' 或 'time'）有效。
    ...
    String maxInterval() default "";// number
//    自动计算的坐标轴最大间隔大小。
//
...
//    只在数值轴或时间轴中（type: 'value' 或 'time'）有效。
    ...
    String interval() default "";// number
//    强制设置坐标轴分割间隔。
//
...
//    无法在类目轴中使用。在时间轴（type: 'time'）中需要传时间戳，在对数轴（type: 'log'）中需要传指数值。
    ...
    String logBase() default "";// number
//[ default: 10 ]
//    对数轴的底数，只在对数轴中（type: 'log'）有效。

    String silent() default "";// boolean
//[ default: false ]
//    坐标轴是否是静态无法交互。
...
//        componentType:() default "";// string,
//                // 未格式化过的刻度值, 点击刻度标签有效
//                value: '',
//            // 坐标轴名称, 点击坐标轴名称有效
//            name: ''
//    }
    String axisLine() default "";// Object
//    坐标轴轴线相关设置。

    String axisTick() default "";// Object
//    坐标轴刻度相关设置。

    String axisLabel() default "";// Object
//    坐标轴刻度标签的相关设置。

    String splitLine() default "";// Object
//    坐标轴在 grid 区域中的分隔线。
...
//        }
//    }, '周二', '周三', '周四', '周五', '周六', '周日']
    String axisPointer() default "";// Object
