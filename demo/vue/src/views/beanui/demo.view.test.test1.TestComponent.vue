...
<el-row>
<el-col :span="24/2" style="padding: 10px;">
<el-card
tag="el-card"
title="test"
>
...
<el-form-item prop="username"
  :label="$t('demo.view.test.test1.TestForm.username')"
>
<el-tooltip content="请输入6位以上用户名"
placement="right"
>
...
<el-form-item prop="password"
  :label="$t('demo.view.test.test1.TestForm.password')"
>
<el-input v-model="testForm.password" type="textarea"
 >
{{testForm.password}}
</el-input>
</el-form-item>
...
<el-form-item prop="cascader"
  label=""
>
<el-cascader v-model="testForm.cascader" :options="testForm.cascaderOptions"
 >
</el-cascader>
</el-form-item>
...
<el-form-item prop="testChart"
  label=""
>
    <demo_view_test_test1_testchart :chart-data="testForm.testChart"></demo_view_test_test1_testchart>
</el-form-item>
<el-form-item prop="file"
  label=""
>
<el-upload icon="el-icon-upload"
drag="true"
 >
...
tag="el-card"
>
<el-form v-loading="testForm2_loading" ref="testForm2" :model="testForm2"
:rules="testForm2_rules"
>
<el-form-item prop="username"
  :label="$t('demo.view.test.test1.TestForm.username')"
>
...
placement="right"
>
<el-input v-model="testForm2.username"  >
{{testForm2.username}}
</el-input>
</el-tooltip>
</el-form-item>
<el-form-item prop="password"
  :label="$t('demo.view.test.test1.TestForm.password')"
>
<el-input v-model="testForm2.password" type="textarea"
 >
{{testForm2.password}}
</el-input>
</el-form-item>
...
<el-badge value="20"
>
<el-switch v-model="testForm2.isAdmin"  >
{{testForm2.isAdmin}}
</el-switch>
</el-badge>
</el-form-item>
<el-form-item prop="lastDate"
  label=""
>
<el-date-picker v-model="testForm2.lastDate"  >
{{testForm2.lastDate}}
</el-date-picker>
</el-form-item>
<el-form-item prop="users"
...
<el-form-item prop="cascader"
  label=""
>
<el-cascader v-model="testForm2.cascader" :options="testForm2.cascaderOptions"
 >
</el-cascader>
</el-form-item>
<el-form-item prop="level"
  label=""
>
<el-rate v-model="testForm2.level"  >
{{testForm2.level}}
</el-rate>
</el-form-item>
<el-form-item prop="detail"
  label=""
>
<el-select v-model="testForm2.detail" :data="testForm2.options"
placeholder="请选择"
 >
    <el-option v-for="item in testForm2.options" :key="item.value" :label="item.label" :value="item.value">
    </el-option>
</el-select>
</el-form-item>
<el-form-item prop="address"
  label=""
>
<el-transfer v-model="testForm2.address" :data="testForm2.addressData"
:titles="['1','2']"
 >
{{testForm2.address}}
</el-transfer>
...
<el-form-item prop="testChart"
  label=""
>
    <demo_view_test_test1_testchart :chart-data="testForm2.testChart"></demo_view_test_test1_testchart>
</el-form-item>
<el-form-item prop="file"
  label=""
>
...
import demo_view_test_test1_testchart from './demo.view.test.test1.TestChart'
  ...
  export default {
    ...
    components: {
        ...
        BackToTop,
        Tinymce,
        demo_view_test_test1_testchart
    },
    data() {
      return {
        myBackToTopStyle: {
...
testForm: {"cascaderOptions":[],"level":0,"admin":false}
,testForm_rules: {
...
testForm2: {"cascaderOptions":[],"level":0,"admin":false}
,testForm2_rules: {
    username: [{"min":"","len":"","max":"","pattern":"","trigger":"","type":"","message":"","required":"true"}],
    password: [{"min":"","len":"","max":"","pattern":"","trigger":"","type":"","message":"","required":"true"}],
    ...
    placeholder_testForm_users() {
      }
    


    ,
    placeholder_testForm_id() {
      }
...
,
    ...
    ,
    placeholder_testForm2_username() {
      }
    ...
    ,
    placeholder_testForm2_password() {
      }
    ...
    ,
    placeholder_testForm2_lastDate() {
      }
    ...
    placeholder_testForm2_users() {
      }
    


    ,
    placeholder_testForm2_id() {
      }
    ...
    ,
    placeholder_testForm2_cascader() {
      }
